...
upload_button = Button(frame, text="Upload Image", highlightthickness=0)
upload_button.grid(column=0, row=3, pady=6)

# button and label to choose and show color
selext_color_button = Button(frame, text="Pick a color")
...
# button out of frame 
watermark_button = Button(text="Watermark Image", highlightthickness=0)
watermark_button.grid(column=0, row=2)


# save button 
save_button = Button(text="Save Image", highlightthickness=0)
